...
/// [MLogInterceptor] is used to print logs during network requests.
/// It's better to add [MLogInterceptor] to the tail of the interceptor queue,
    ...
    if (requestBody) {
      ...
      if (options.data != null) {
        if (options.data is FormData) {
          ...
          var content = '{';
          var formData = options.data as Map
            ..forEach((key, value) {
              if (value is String) {
                content += '\n$key:$value';
              }
