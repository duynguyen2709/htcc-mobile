...
class DetailStatisticScreen extends StatefulWidget {
  ...
  const DetailStatisticScreen({Key key, this.date, this.listDetail})
      : super(key: key);

  @override
  _DetailStatisticScreenState createState() =>
      _DetailStatisticScreenState(date, listDetail);
}
                  ...
                  child: Padding(
                    ...
                    child: ListView.builder(
                        itemBuilder: (context, index) =>
                            buildCheckDetailItem(data[index]),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                              ...
                              child: new Container(
                                ...
                                decoration: new BoxDecoration(
                                    shape: BoxShape
                                        .circle,
                                    color: model.type ==
                                        1 ? Colors.lightGreen : Color(0xEEFF9A00)),
                              ),
                            ),
                          ),
                          Text(
                      ...
                      model.approver.isNotEmpty ? Padding(
                      ...
                      model.reason.isNotEmpty ? Padding(
                        padding: EdgeInsets.fromLTRB(24, 2, 8, 2),
                        child: Text(
                          "Lý do: ${model.reason}",
                          textAlign:
